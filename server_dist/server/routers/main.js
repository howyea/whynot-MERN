...
var data;
var xunfeisdk = require("xunfeisdk");
var _a = require("xunfeisdk"), IATAueType = _a.IATAueType, IATEngineType = _a.IATEngineType, ISEAueType = _a.ISEAueType, ISECategoryType = _a.ISECategoryType, ISELanguageType = _a.ISELanguageType, ISEResultLevelType = _a.ISEResultLevelType, TTSAueType = _a.TTSAueType, TTSAufType = _a.TTSAufType, TTSEngineType = _a.TTSEngineType, TTSVoiceName = _a.TTSVoiceName;
/*
* 处理通用的数据
* */
...
router.get('/xunfei', function (req, res, next) {
    var client = new xunfeisdk.Client("5b98829a");
    ...
    try {
        ...
        client.TTS("科大讯飞的接口文档写的太烂了", TTSAufType.L16_8K, TTSAueType.LAME, TTSVoiceName.XiaoYan)
            ...
            var mp3 = path.join(__dirname, "要存成的文件.mp3");
            console.log(result);
