...
//发送者昵称与邮箱地址
let EmailFrom = '"叶辉宇" <yhynew@126.com>';

//接收者邮箱地
let EmailTo = "1070231248@qq.com";
//邮件主题
...
function getAllDataAndSendMail(){
    ...
    console.log(today)
    let initDay:any = new Date(startDay);
    let lastDay:any = Math.floor((today - initDay) / 1000 / 60 / 60 / 24);
    let todaystr =
      today.getFullYear() +
      " / " +
      (today.getMonth() + 1) +
